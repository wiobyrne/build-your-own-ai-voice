...
The samples in your Modelfile are the most important part of the whole system. Rules tell the model what to do. Samples show it what that actually looks like in your writing. If you get the samples right, the model will pick up patterns you did not even think to name.

This guide walks through how to find and select them.

---

## A quick definition

When I say "writer voice", I mean the habits that make your writing feel like yours:

- how you open
- how you explain
- what kinds of examples you choose
- how much context you assume
- how you close

This is not about sounding fancy. It is about sounding like the same person across drafts, posts, and notes.
...
You are not looking for your best writing in a general sense. You are looking for your most *characteristic* writing - pieces that, if a reader knew you well, they would immediately recognize as yours.

Avoid:
- Pieces written in a rush that do not represent your usual patterns
...
The patterns you follow *without thinking* are the most important to name. If you have to deliberate about whether you do something, it is probably not a strong enough pattern to encode.
...
You do not need all five. Pick the ones that represent how you actually write. If you rarely write personal narrative, do not force a sample into that slot.
...
- Writing you are proud of - not because it is showy, but because it is precise
...
The hardest part of this process is reading your own writing without flinching. You will find patterns you did not intend and habits you do not love. That is the point. The model learns from what you actually wrote, not what you meant to write.
